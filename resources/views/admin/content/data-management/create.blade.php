<x-layouts.admin title="Create Data Entry">
    <div class="space-y-6">
        <!-- Page Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Create Data Entry</h1>
                <p class="text-zinc-600 dark:text-zinc-400">Add a new data entry to your system</p>
            </div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 shadow-sm">
            <form action="{{ route('admin.content.data-management.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="flex items-center justify-end gap-3 pt-4">
                    ...
                    <x-button variant="primary" type="submit" icon="save" icon-position="left">Create Entry</x-button>
                </div>
            </form>
        </div>
    </div>
