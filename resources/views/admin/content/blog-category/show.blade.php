    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <x-button variant="primary" icon="edit" icon-position="left" href="{{ route('admin.content.blog-category.edit', $blogCategory) }}">Edit Category</x-button>
            </div>
        </div>
