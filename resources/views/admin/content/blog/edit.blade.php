<x-layouts.admin title="Edit Blog">
    <div class="space-y-6">
        ...
        <form action="{{ route('admin.content.blog.update', $blog) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-md p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-quill 
                                name="long_body" 
                                :value="old('long_body', $blog->long_body)" 
                                placeholder="Write your blog content here..."
                                class="h-[500px] fixed-height"
                            />
                            @error('long_body')
                                <p class="mt-1 text-sm text-error">{{ $message }}</p>
                            @enderror
