<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Footer Menu</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Manage footer navigation menu items. Drag items to reorder. Changes save automatically.</p>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @else
                <div class="flex flex-wrap gap-4" data-footer-menu-sortable data-parent-id="">
                        ...
                        >
                            ...
                            @if($hasChildren && $isExpanded)
                                <div class="mt-3 relative">
                                    ...
                                    <ul class="space-y-2.5 list-none pl-6 relative" data-footer-menu-sortable data-parent-id="{{ $item->id }}">
            ...
            <script>
                document.addEventListener('livewire:init', () => {
                    ...
                    const initializeSortables = () => {
                        ...
                        document.querySelectorAll('[data-footer-menu-sortable]').forEach(container => {
                    ...
                    Livewire.hook('morph.updated', ({ component }) => {
                        ...
                        if (componentEl && componentEl.querySelector('[data-footer-menu-sortable]')) {
                            setTimeout(initializeSortables, 100);
                        }
                    });
                });
