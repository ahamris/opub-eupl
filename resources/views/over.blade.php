    ...
    <div class="relative isolate overflow-hidden bg-surface py-24 sm:py-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <p class="text-base/7 font-semibold text-primary">Open source Woo-voorziening</p>
            ...
            <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
                <!-- Content -->
                <div class="max-w-xl text-base/7 text-on-surface-variant lg:col-span-12">
                    <div class="space-y-12">
                        <!-- Projectdoelstelling -->
                        <div>
                            <h2 class="text-2xl font-bold tracking-tight text-on-surface mb-4">
                                Projectdoelstelling
                            </h2>
                            <p class="text-base/7 text-on-surface-variant">
                            ...
                            <p class="text-base/7 text-on-surface-variant mt-4">
                        ...
                        <div>
                            ...
                            <p class="text-base/7 text-on-surface-variant mb-4">
                            ...
                            <ul role="list" class="mt-4 space-y-3 text-base/7 text-on-surface-variant">
                                <li class="flex gap-x-3">
                                    <i class="fas fa-check-circle text-primary mt-1 flex-none" aria-hidden="true"></i>
                                    <span><strong class="font-semibold text-on-surface">Laravel 12</strong> voor de applicatielaag</span>
                                </li>
                                <li class="flex gap-x-3">
                                    <i class="fas fa-check-circle text-primary mt-1 flex-none" aria-hidden="true"></i>
                                    <span><strong class="font-semibold text-on-surface">Go</strong> voor het actief harvesten van bronnen zoals open.overheid.nl en zoek.openraadsinformatie.nl</span>
                                </li>
                                <li class="flex gap-x-3">
                                    <i class="fas fa-check-circle text-primary mt-1 flex-none" aria-hidden="true"></i>
                                    <span><strong class="font-semibold text-on-surface">PostgreSQL 12</strong> en <strong class="font-semibold text-on-surface">Typesense</strong> voor opslag en razendsnelle zoekfunctionaliteit</span>
                                </li>
                                <li class="flex gap-x-3">
                                    <i class="fas fa-check-circle text-primary mt-1 flex-none" aria-hidden="true"></i>
                                    <span><strong class="font-semibold text-on-surface">Ollama AI (local)</strong> voor slimme vind- en duidfuncties</span>
                                </li>
                                <li class="flex gap-x-3">
                                    <i class="fas fa-check-circle text-primary mt-1 flex-none" aria-hidden="true"></i>
                                    <span><strong class="font-semibold text-on-surface">Tailwind CSS 4</strong> voor een moderne, toegankelijke front-end</span>
                                </li>
                            </ul>
                            <p class="text-base/7 text-on-surface-variant mt-4">
                        ...
                        <div>
                            ...
                            <ul role="list" class="mt-4 space-y-6 text-base/7 text-on-surface-variant">
                                <li class="flex gap-x-3">
                                    <i class="fas fa-cloud-upload-alt text-primary mt-1 size-5 flex-none" aria-hidden="true"></i>
                                    <span>
                                        <strong class="font-semibold text-on-surface">Moderne, transparante architectuur.</strong>
                                ...
                                <li class="flex gap-x-3">
                                    <i class="fas fa-lock text-primary mt-1 size-5 flex-none" aria-hidden="true"></i>
                                    <span>
                                        <strong class="font-semibold text-on-surface">Actieve openbaarmaking als uitgangspunt.</strong>
                                ...
                                <li class="flex gap-x-3">
                                    <i class="fas fa-users text-primary mt-1 size-5 flex-none" aria-hidden="true"></i>
                                    <span>
                                        <strong class="font-semibold text-on-surface">Samen leren, samen versnellen.</strong>
                        ...
                        <div class="flex items-start gap-4 pt-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 rounded-full bg-primary-container flex items-center justify-center">
                                    <i class="fas fa-question-circle text-2xl text-on-primary-container" aria-hidden="true"></i>
                                </div>
                            </div>
                            <div class="flex-1">
                                <h2 class="text-2xl font-bold tracking-tight text-on-surface mb-4">
                                ...
                                <a href="#" class="inline-flex items-center gap-2 text-primary font-medium text-base hover:underline focus:outline-2 focus:outline-primary focus:outline-offset-2 rounded-sm">
                                    Link naar contact
