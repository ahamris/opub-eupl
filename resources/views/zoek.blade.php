...
@section('content')
    ...
    @if(request()->routeIs('home'))
    <div class="bg-gradient-to-b from-white via-slate-50/50 to-white py-16 sm:py-20">
        <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
            <!-- Section Header -->
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-10">
                <div>
                    <p class="text-sm font-medium uppercase tracking-wider text-[var(--color-primary)]">Snel aan de slag</p>
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-6 lg:grid-rows-2">
                ...
                <a href="{{ route('themas.index') }}" class="group lg:col-span-4">
                    <div class="relative h-full overflow-hidden rounded-md bg-white ring-1 ring-slate-200/60">
                        <div class="aspect-[16/9] sm:aspect-[3/1] overflow-hidden">
                        ...
                        <div class="p-6 lg:p-8">
                            <h3 class="text-lg font-semibold text-[var(--color-on-surface)] group-hover:text-[var(--color-primary)] transition-colors">
                                Thema's
                            </h3>
                            <p class="mt-1.5 text-sm text-[var(--color-on-surface-variant)] leading-relaxed">
    ...
    <div class="bg-white py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-10">
                <div>
                    <p class="text-sm font-medium uppercase tracking-wider text-[var(--color-primary)]">Leren & ontdekken</p>
                    <h2 class="mt-2 text-3xl font-semibold tracking-tight text-[var(--color-on-surface)] sm:text-4xl">
                        Kennisbank
                    </h2>
                </div>
    ...
    <div class="relative isolate bg-gradient-to-b from-slate-50 to-white py-16 sm:py-20">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-12 lg:max-w-none lg:grid-cols-2 lg:items-center">
                <div class="max-w-xl">
                    <p class="text-sm font-medium uppercase tracking-wider text-[var(--color-primary)]">Nieuwsbrief</p>
                    <h2 class="mt-2 text-2xl font-semibold tracking-tight text-[var(--color-on-surface)] sm:text-3xl">
                        Blijf op de hoogte
                    </h2>
                    <p class="mt-4 text-sm text-[var(--color-on-surface-variant)] leading-relaxed">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="relative rounded-md bg-white p-6 ring-1 ring-slate-200/60">
                        <div class="inline-flex items-center justify-center w-10 h-10 rounded-md bg-[var(--color-primary)]/10 mb-4">
                    ...
                    <div class="relative rounded-md bg-white p-6 ring-1 ring-slate-200/60">
                        <div class="inline-flex items-center justify-center w-10 h-10 rounded-md bg-emerald-500/10 mb-4">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="w-5 h-5 text-emerald-600">
