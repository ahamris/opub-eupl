...
@section('content')
    ...
    @if(request()->routeIs('home'))
    <div class="bg-[var(--color-surface-variant)] py-24 sm:py-32 dark:bg-[var(--color-surface)]">
        <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
            ...
            <p class="mt-2 max-w-lg text-[var(--font-size-display-large)] font-semibold tracking-tight text-pretty text-[var(--color-on-surface)] sm:text-[var(--font-size-display-large)] dark:text-[var(--color-on-surface)]">
                Alles wat je nodig hebt
            </p>
            <div class="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
                <!-- Thema's - 4 columns -->
                <a href="{{ route('themas.index') }}" class="flex p-px lg:col-span-4">
                    <div class="w-full overflow-hidden rounded-md bg-[var(--color-surface)] shadow-sm outline outline-black/5 dark:bg-[var(--color-surface-variant)] dark:shadow-none dark:outline-white/15">
                        ...
                        <div class="p-10">
                            <h3 class="text-[var(--font-size-label-medium)]/4 font-semibold text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">Thema's</h3>
                            <p class="mt-2 text-[var(--font-size-body-large)] font-medium tracking-tight text-[var(--color-on-surface)] dark:text-[var(--color-on-surface)]">Zoek op onderwerp</p>
                            <p class="mt-2 max-w-lg text-[var(--font-size-body-small)]/6 text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">
                ...
                <a href="{{ route('dossiers.index') }}" class="flex p-px lg:col-span-2">
                    <div class="w-full overflow-hidden rounded-md bg-[var(--color-surface)] shadow-sm outline outline-black/5 dark:bg-[var(--color-surface-variant)] dark:shadow-none dark:outline-white/15">
                        ...
                        <div class="p-10">
                            <h3 class="text-[var(--font-size-label-medium)]/4 font-semibold text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">Dossiers</h3>
                            <p class="mt-2 text-[var(--font-size-body-large)] font-medium tracking-tight text-[var(--color-on-surface)] dark:text-[var(--color-on-surface)]">Verken complete dossiers</p>
                            <p class="mt-2 max-w-lg text-[var(--font-size-body-small)]/6 text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">
                ...
                <a href="{{ route('zoeken') }}" class="flex p-px lg:col-span-2">
                    <div class="w-full overflow-hidden rounded-md bg-[var(--color-surface)] shadow-sm outline outline-black/5 dark:bg-[var(--color-surface-variant)] dark:shadow-none dark:outline-white/15">
                        ...
                        <div class="p-10">
                            <h3 class="text-[var(--font-size-label-medium)]/4 font-semibold text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">Uitgebreid zoeken</h3>
                            <p class="mt-2 text-[var(--font-size-body-large)] font-medium tracking-tight text-[var(--color-on-surface)] dark:text-[var(--color-on-surface)]">Filters en precieze resultaten</p>
                            <p class="mt-2 max-w-lg text-[var(--font-size-body-small)]/6 text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">
                ...
                <a href="{{ route('verwijzingen') }}" class="flex p-px lg:col-span-4">
                    <div class="w-full overflow-hidden rounded-md bg-[var(--color-surface)] shadow-sm outline outline-black/5 dark:bg-[var(--color-surface-variant)] dark:shadow-none dark:outline-white/15">
                        ...
                        <div class="p-10">
                            <h3 class="text-[var(--font-size-label-medium)]/4 font-semibold text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">Verwijzingen</h3>
                            <p class="mt-2 text-[var(--font-size-body-large)] font-medium tracking-tight text-[var(--color-on-surface)] dark:text-[var(--color-on-surface)]">Gerelateerde links en bronnen</p>
                            <p class="mt-2 max-w-lg text-[var(--font-size-body-small)]/6 text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">
    ...
    @if(request()->routeIs('home'))
    <div class="bg-[var(--color-surface)] py-24 sm:py-32 dark:bg-[var(--color-surface)]">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="max-w-2xl">
                <h2 class="text-[var(--font-size-display-large)] font-semibold tracking-tight text-balance text-[var(--color-on-surface)] sm:text-[var(--font-size-display-large)] dark:text-[var(--color-on-surface)]">Kennisbank</h2>
                <p class="mt-2 text-[var(--font-size-body-large)]/8 text-[var(--color-on-surface-variant)] dark:text-[var(--color-on-surface-variant)]">Leer meer over open data, transparantie en hoe je het platform gebruikt</p>
            </div>
            ...
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                ...
                <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                    <div class="flex flex-col items-start">
                        <div class="rounded-md bg-[var(--color-surface)]/50 p-2 ring-1 ring-[var(--color-outline-variant)]">
