<x-guest-layout>
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">Sign in to access Typesense GUI</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <x-primary-button class="ms-3 bg-purple-600 hover:bg-purple-700 focus:ring-purple-500">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
