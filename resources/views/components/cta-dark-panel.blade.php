...
<div class="bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-7xl py-16 sm:px-6 sm:py-24 lg:px-8">
        <div class="relative isolate overflow-hidden bg-[var(--color-primary-dark)] px-6 pt-16 shadow-2xl sm:rounded-md sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
