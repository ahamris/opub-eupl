<!-- Modern Sticky Header adapted from Tailwind example -->
<header class="sticky top-0 z-50 bg-white dark:bg-gray-900 border-b border-[var(--color-outline-variant)]/50 shadow-sm backdrop-blur-sm" role="banner" x-data="{ mobileMenuOpen: false }">
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        <div class="flex lg:flex-1 items-center gap-3">
            <a href="{{ route('home') }}" class="-m-1.5 p-1.5 flex items-center gap-2">
                ...
                <span class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10 text-primary font-semibold text-sm">
                    OO
                </span>
                <div class="hidden sm:flex flex-col">
                    <span class="text-sm font-semibold text-gray-900 dark:text-white">Overheid.nl</span>
                </div>
            </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-8">
            <a href="{{ route('home') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('home') || request()->routeIs('zoek') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                Home
            </a>
            <a href="{{ route('zoeken') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('zoeken') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                Zoeken
            </a>
            <a href="{{ route('themas.index') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('themas.*') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                Thema's
            </a>
            <a href="{{ route('dossiers.index') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('dossiers.*') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                Dossiers
            </a>
            <a href="{{ route('reports.index') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('reports.*') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                In cijfers
            </a>
            <a href="{{ route('verwijzingen') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('verwijzingen') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                Verwijzingen
            </a>
            <a href="{{ route('over') }}" class="text-sm font-semibold leading-6 {{ request()->routeIs('over') ? 'text-primary' : 'text-gray-900 dark:text-white hover:text-primary' }}">
                Over
            </a>
        </div>
    ...
    <div
        ...
        class="lg:hidden border-t border-[var(--color-outline-variant)]/50 bg-white/98 dark:bg-gray-900/95 backdrop-blur-sm"
    >
        <nav class="mx-auto max-w-7xl px-6 py-4 space-y-1" aria-label="Mobiele navigatie">
            <a href="{{ route('home') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('home') || request()->routeIs('zoek') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                Home
            </a>
            <a href="{{ route('zoeken') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('zoeken') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                Zoeken
            </a>
            <a href="{{ route('themas.index') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('themas.*') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                Thema's
            </a>
            <a href="{{ route('dossiers.index') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('dossiers.*') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                Dossiers
            </a>
            <a href="{{ route('reports.index') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('reports.*') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                In cijfers
            </a>
            <a href="{{ route('verwijzingen') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('verwijzingen') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                Verwijzingen
            </a>
            <a href="{{ route('over') }}" class="block rounded-lg px-3 py-2 text-base font-semibold {{ request()->routeIs('over') ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                Over
            </a>
        </nav>
    </div>
